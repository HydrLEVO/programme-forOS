...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("welcome to Hydra-pad")
    # Creating Menubar
  ...
  def openfile(self,*args):
    ...
    try:
      ...
      self.filename = filedialog.askopenfilename(title = "Select file",filetypes = (("All Files","*.*"),("Text Files","*.txt"),("Python Files","*.py"),("c Files","*.c"),("c++ Files","*.c++"),("c# Files","*.c#")))
  ...
  def saveasfile(self,*args):
    ...
    try:
      ...
      untitledfile = filedialog.asksaveasfilename(title = "Save file As",defaultextension=".txt",initialfile = "Untitled.txt",filetypes = (("All Files","*.*"),("Text Files","*.txt"),("Python Files","*.py"),("c Files","*.c"),("c++ Files","*.c++"),("c# Files","*.c#")))
      # Reading the data from text area
      data = self.txtarea.get("1.0",END)
      # opening File in write mode
  ...
  def infoabout(self):
    messagebox.showinfo("about this programme, this is a highly developed function system to operate codes. BY LEVO-HYDRA")
